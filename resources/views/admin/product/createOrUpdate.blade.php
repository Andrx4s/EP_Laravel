...
{{--Секция создания и редактирования продуктов--}}
@section('content')
    <div class="container">
        <div class="row">
            <div class="col"></div>
            <div class="col-6">
                ...
                <form method="POST" action="{{(isset($product) ? route('admin.product.update', ['product' => $product->id]) : route('admin.product.store'))}}" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="description" class="form-control @error('description') is-invalid @enderror" id="exampleFormControlTextarea1" rows="3" aria-describedby="invalidInputDescription">{{old('description')}}</textarea>
